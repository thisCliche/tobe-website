	...
	<view class="science">
		...
		<view class="container3">
			...
			"></i><text class="cursor-pointer">活动</text>
				...
				<vue-waterfall-easy ref="waterfall" :imgsArr="pictureList" :height="800" :maxCols="4" @click="clickFn"
					@scrollReachBottom="getPictrueData">
					<!-- 图片信息 -->
				...
				<view class="disctory">
					...
					<view class="disctory-list">
						<view class="list-item">
							<view class="item-img">
								<image src="@/assets/image/resource/夏校配图.png" mode=""></image>
