<template>
	<view class="science">
		...
		<view class="container3">
			...
			"></i><text class="cursor-pointer">活动</text>


			</view>

			<vue-waterfall-easy ref="waterfall" :imgsArr="pictureList" :height="800" :maxCols="4" :gap='46'
				@click="clickFn" @scrollReachBottom="getPictrueData">
				<!-- 图片信息 -->
			...
			<view class="disctory">
				...
				<view class="disctory-list">
					<view class="list-item" v-for="item in 8 " :key="item" @click="goDteial(item)">
...
<script>
	...
	export default {
		...
		methods: {
			...
			goDteial(item){
				uni.navigateTo({
									url: `/pages/activity/clubDteail?id=${item}`,
								})
