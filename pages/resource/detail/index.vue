<template>
  <view class="IndexPage">
    ...
    <view class="container1">
      <view class="title"> 人工智能与chatgpt </view>
      <view class="content">
